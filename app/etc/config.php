...
return [
    'modules' => [
        ...
        'Dcs_CustomShippingPrice' => 1,
        'Dcs_DeferJS' => 1,
        'Dcs_Downloadcatalogue' => 1,
        'Dcs_Easypathhints' => 1,
        'Dcs_Megamenuimg' => 1,
        'Dcs_Newsletter' => 1,
        'Dcs_Parentgroupfixed' => 0,
        'Dcs_Productenquiry' => 1,
        'Dcs_Updateaccount' => 1,
        'DigitalPianism_Reindex' => 1,
        'Digital_Contactus' => 1,
        'Digital_CustomAPI' => 1,
        'Digital_CustomShipping' => 1,
        'Digital_CustomValidation' => 1,
        'Digital_Homebanner' => 1,
        'Digital_Homeimage' => 1,
        'Digital_Restrictproducts' => 1,
        'Digital_Warehouse' => 1,
