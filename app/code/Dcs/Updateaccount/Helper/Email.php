...
{
    const XML_PATH_EMAIL_TEMPLATE_FIELD  = 'updateaccount/email/admin_email';
    const XML_PATH_EMAIL_TEMPLATE_FIELD_CUSTOMER  = 'updateaccount/email/email_template';
    ...
    */
    ...
    public function generateTemplate($emailTemplateVariables,$senderInfo,$receiverInfo)
    {
		$template =  $this->_transportBuilder->setTemplateIdentifier($this->temp_id)
                ...
                //->addAttachment("Hello I m here" ,"attatched");
        return $this;        
    }
   ...
   public function updateaccountMailSendMethod($emailTemplateVariables,$senderInfo,$receiverInfo)
    {
    ...
    public function updateaccountMailSendMethodToCustomer($emailTemplateVariables,$senderInfo,$receiverInfo)
    {
