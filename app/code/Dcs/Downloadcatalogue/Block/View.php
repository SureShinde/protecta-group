...
class View extends \Magento\Framework\View\Element\Template
{
    ...
    {
        $this->pageConfig->getTitle()->set($this->getDownloadcatalogue()->getTitle());
    }
     ...
     */
    public function getDownloadcatalogue()
    {
        return $this->_coreRegistry->registry('current_downloadcatalogue');
    }
    ...
    {
        return $this->getUrl('downloadcatalogue/index/index');
    }
