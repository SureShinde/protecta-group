...
class Edit extends \Magento\Backend\Block\Widget\Form\Container
{
    ...
    protected function _construct()
    {
        ...
        if ($this->_isAllowedAction('Digital_Warehouse::warehouse_delete')) {
    ...
    public function getHeaderText()
    {
        if ($this->_coreRegistry->registry('warehouse')->getId()) {
            return __("Edit Warehouse '%1'", $this->escapeHtml($this->_coreRegistry->registry('warehouse')->getTitle()));
        } else {
    ...
    {
        return $this->getUrl('warehouse/*/save', ['_current' => true, 'back' => 'edit', 'active_tab' => '{{tab_id}}']);
    }
