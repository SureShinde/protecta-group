...
class Email extends \Magento\Framework\App\Helper\AbstractHelper
{
    ...
    const XML_PATH_EMAIL_TEMPLATE_FIELD_CUSTOMER  = 'warehouse/view/email_template';
	 const XML_PATH_EMAIL_TEMPLATE_FIELD_ADMIN  = 'warehouse/view/admin_email';
    ...
    */
    ...
    public function warehouseEnquiryMailSendMethod($emailTemplateVariables,$senderInfo,$receiverInfo)
    {
	...
	public function warehouseMailSendMethodToCustomer($emailTemplateVariables,$senderInfo,$receiverInfo)
    {
