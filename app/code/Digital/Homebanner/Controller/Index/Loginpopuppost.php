 ...
 */
class Loginpopuppost extends \Magento\Framework\App\Action\Action implements HttpPostActionInterface
{
    /**
    ...
    public function execute()
    {
        ...
        try {
            $credentials['username'] = $this->getRequest()->getParam('email');
            $credentials['password'] = $this->getRequest()->getParam('password');
        } catch (\Exception $e) {
