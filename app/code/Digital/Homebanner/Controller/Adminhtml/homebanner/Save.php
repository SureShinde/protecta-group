...
class Save extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        if (isset($_FILES['image']) && isset($_FILES['image']['name']) && strlen($_FILES['image']['name'])) {
            ...
            try {
                $model->save();
                $this->messageManager->addSuccess(__('The Home Banner has been saved.'));
                ...
                $this->messageManager->addException($e, __('Something went wrong while saving the Home Banner.'));
            }
