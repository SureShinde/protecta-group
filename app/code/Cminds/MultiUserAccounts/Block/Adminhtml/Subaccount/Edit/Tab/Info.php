...
class Info extends Generic implements TabInterface
{
    ...
    protected function _prepareForm()
    {
        ...
        if($subaccountTransportDataObject->getCustomerId())
        {
            ...
            {
              $pg_phonenumber = $customer->getCustomAttribute('pg_phonenumber')->getValue();
            }
            else
            {
              $pg_phonenumber = ''; 
        ...
        //$subaccountTransportDataObject->setPgPhonenumber($pg_phonenumber);  
        //echo '<pre>'; print_r($subaccountTransportDataObject); exit;
        ...
        //echo '<pre>';
        $subaccountTransportDataArray['pg_phonenumber'] = $pg_phonenumber;
        //print_r($subaccountTransportDataArray); exit();
