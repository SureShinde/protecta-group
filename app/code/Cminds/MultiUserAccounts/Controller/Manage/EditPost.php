...
class EditPost extends AbstractManage
{
    ...
    public function execute()
    {
        ...
        try {
            ...
            /*echo '<pre>';
            echo $subaccountTransportDataObject->getIsActive();
            echo $subaccountTransportDataObject->getPgPhonenumber();            
            exit;*/

            $customerModel
                ->setData('pg_phonenumber', $subaccountTransportDataObject->getPgPhonenumber())
                ->getResource()
                ->saveAttribute($customerModel, 'pg_phonenumber');
