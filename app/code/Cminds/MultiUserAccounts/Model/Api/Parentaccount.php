...
class Parentaccount implements ParentaccountInterface
{
    ...
    public function getById($parentId)
    {
        ...
        $customerAccountphonenumnber = $customer->getCustomAttribute('pg_phonenumber');
        if ($customerAccountphonenumnber !== null) {
            $customerAccountphonenumnber = $customerAccountphonenumnber->getValue();
        } else {
            $customerAccountphonenumnber = '';
        }
        ...
        $customerData = [
            ...
            'is_active' => $isActive,
            'pg_phonenumber' => $customerAccountphonenumnber,
        ...
        foreach ($subaccountIds as $subaccountId) {
            ...
            if ($subaccountCustomer->getCustomAttribute('pg_phonenumber')) {
                $customerAccountphonenumnber = $subaccountCustomer->getCustomAttribute('pg_phonenumber')->getValue();
            } else {
                $customerAccountphonenumnber = '';
            }            
    ...
    public function create(ApiParentAccountInterface $parentCustomerData)
    {
        ...
        $customer = $this->customerRegistry
            ->retrieveByEmail($parentCustomerData->getEmail());
