...
{
   const PGPHONENUMBER = 'pg_phonenumber';
    /**
     * {@inheritdoc}
     */
     ...
     * {@inheritdoc}
     */
    public function getPgPhonenumber()
    {
        return $this->_get(self::PGPHONENUMBER);
    }

    /**
     * {@inheritdoc}
     */
    public function setPgPhonenumber($pgphonenumber)
    {
        $this->setData(self::PGPHONENUMBER, $pgphonenumber);
        return $this;
    }
