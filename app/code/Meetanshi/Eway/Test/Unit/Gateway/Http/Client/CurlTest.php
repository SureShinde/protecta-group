 ...
 */
namespace Meetanshi\Eway\Test\Unit\Gateway\Http\Client;
...
use Meetanshi\Eway\Gateway\Http\Client\ResponseFactory;

/**
 * Class Test
 *
 * Test for class \Meetanshi\Eway\Gateway\Http\Client\Curl
 *
...
class CurlTest extends \PHPUnit\Framework\TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->loggerMock = $this->getMockBuilder(\Magento\Payment\Model\Method\Logger::class)
            ...
            ->getMock();
        $this->responseFactoryMock = $this->getMockBuilder(\Meetanshi\Eway\Gateway\Http\Client\ResponseFactory::class)
            ->getMock();
