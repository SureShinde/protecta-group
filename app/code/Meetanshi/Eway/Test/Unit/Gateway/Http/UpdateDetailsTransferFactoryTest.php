 ...
 */
namespace Meetanshi\Eway\Test\Unit\Gateway\Http;

use Meetanshi\Eway\Gateway\Helper\Request\Action;
use Meetanshi\Eway\Gateway\Http\UpdateDetailsTransferFactory;
...
class UpdateDetailsTransferFactoryTest extends \PHPUnit\Framework\TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->action = $this->getMockBuilder(\Meetanshi\Eway\Gateway\Helper\Request\Action::class)
