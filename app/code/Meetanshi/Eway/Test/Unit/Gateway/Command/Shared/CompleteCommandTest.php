 ...
 */
namespace Meetanshi\Eway\Test\Unit\Gateway\Command\Shared;

use Meetanshi\Eway\Gateway\Command\Shared\CompleteCommand;
use Meetanshi\Eway\Gateway\Command\Shared\UpdateDetailsCommand;
use Meetanshi\Eway\Gateway\Command\Shared\UpdateOrderCommand;
...
class CompleteCommandTest extends \PHPUnit\Framework\TestCase
{
    ...
    protected function setUp()
    {
        $this->updateDetailsCommandMock = $this
            ->getMockBuilder(\Meetanshi\Eway\Gateway\Command\Shared\UpdateDetailsCommand::class)
            ->disableOriginalConstructor()
            ->getMock();

        $this->updateOrderCommandMock = $this
            ->getMockBuilder(\Meetanshi\Eway\Gateway\Command\Shared\UpdateOrderCommand::class)
            ->disableOriginalConstructor()
            ->getMock();
