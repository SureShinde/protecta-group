 ...
 */
namespace Meetanshi\Eway\Test\Unit\Gateway\Response\Direct;

use Magento\Sales\Model\Order\Payment;
use Meetanshi\Eway\Model\Adminhtml\Source\Cctype;
use Meetanshi\Eway\Gateway\Response\Direct\CardDetailsHandler;
use Magento\Payment\Gateway\Data\PaymentDataObjectInterface;

/**
 * Class CardDetailsHandlerTest
 *
 * Test for class \Meetanshi\Eway\Gateway\Response\Direct\CardDetailsHandler
 */
class CardDetailsHandlerTest extends \PHPUnit\Framework\TestCase
{
    ...
    {
        $this->sourceCCtypeMock = $this->getMockBuilder(\Meetanshi\Eway\Model\Adminhtml\Source\Cctype::class)
