 ...
 */
namespace Meetanshi\Eway\Gateway\Validator;

use Meetanshi\Eway\Gateway\Request\RequestDataBuilder;
...
abstract class AbstractResponseValidator extends AbstractValidator
{
    ...
    protected function validateResponseCode(array $response)
    {
        ...
        && (($response[self::RESPONSE_CODE] === self::RESPONSE_CODE_ACCEPT) || ($response[self::RESPONSE_CODE] === '08'));        
    }
