 ...
 */
namespace Meetanshi\Eway\Controller\Order;
...
class Denied extends Action
{
    ...
    public function execute()
    {
        ...
        $this->messageManager->addErrorMessage('Transaction has been declined. Please try again later.');
