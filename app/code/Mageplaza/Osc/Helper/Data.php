...
class Data extends AbstractData
{
    ...
    {
        $layoutTemplate = 'Mageplaza_Osc/' . $this->getDesignConfig('page_layout', $store);
    ...
    public function isChildCustomer() {
        $subaccountData = $this->_customerSession->getSubaccountData();
        if($subaccountData) {
            return true;
        }
