    ...
    {        
        ...
        foreach ($collections as $product) {
            ...
            if ($_product->getVisibility() == 1) {
                ...
                $product_ids = array_diff($product_ids, array($product->getProductId()));
            }
            //Grouped Product
...
//        }
        ...
        $collectioncat->addCategoriesFilter(array('in'=> $categoryIds));
        $prod = [];
        ...
        foreach ($prod as $productid) {
            ...
            if ($_product->getVisibility() == 1) {
                ...
                $product_ids_cat = array_diff($product_ids_cat, array($productid));
            }
            //Grouped Product
