...
class UpdateToCartFinalPrice implements ObserverInterface
{
    protected $logger;
    ...
    public function execute(\Magento\Framework\Event\Observer $observer)
    {
        ...
        if ($isLoggedIn && $this->helper->isEnabled()) {
            ...
            foreach ($observer->getCart()->getQuote()->getAllItems() as $item) {
                ...
                if ($finalPrice) {
                    if (gettype($finalPrice) == 'object') {
                        ...
                        if ($item->getParentItem()) {
                            ...
                            if ($parent_item->getProduct()->getTypeId() == 'bundle' && $product->getTypeId() != 'configurable') {
                                $qty = $item->getQty();
                            } else {
