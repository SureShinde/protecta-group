...
class Grid extends \Magento\Backend\Block\Widget\Grid\Extended
{
    ...
    \Magento\Backend\Block\Template\Context $context, \Magento\Backend\Helper\Data $backendHelper, \Magento\Catalog\Model\ProductFactory $productFactory, \Magento\Catalog\Model\Config $catalogConfig, \Magento\Backend\Model\Session\Quote $sessionQuote, \Magento\Sales\Model\Config $salesConfig, \Magento\Catalog\Model\Product\Type $type, \Magento\Framework\Module\Manager $moduleManager, array $data = []
    ) {
    ...
    protected function _prepareCollection()
    {
        ...
        $collection->setStore($this->getStore())
                ...
                ->addStoreFilter()
                ->addAttributeToFilter('type_id', array('simple', 'downloadable', 'virtual'));
    ...
    {
        return $this->getUrl(
                        'md_customerprice/*/loadblock', ['block' => 'customer_product_grid', '_current' => true, 'collapse' => null]
        );
    }
