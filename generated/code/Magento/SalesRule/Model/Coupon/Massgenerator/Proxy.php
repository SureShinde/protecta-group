<?php
namespace Magento\SalesRule\Model\Coupon\Massgenerator;

/**
 * Proxy class for @see \Magento\SalesRule\Model\Coupon\Massgenerator
 */
class Proxy extends \Magento\SalesRule\Model\Coupon\Massgenerator implements \Magento\Framework\ObjectManager\NoninterceptableInterface
{
    /**
     ...
     * @param bool $shared
     */
    public function __construct(\Magento\Framework\ObjectManagerInterface $objectManager, $instanceName = '\\Magento\\SalesRule\\Model\\Coupon\\Massgenerator', $shared = true)
    {
    ...
    {
        return $this->_getSubject()->generateCode();
    }
    ...
    {
        return $this->_getSubject()->getDelimiter();
    }
    ...
    {
        return $this->_getSubject()->generatePool();
    }
    ...
    {
        return $this->_getSubject()->validateData($data);
    }
    ...
    {
        return $this->_getSubject()->getGeneratedCodes();
    }
    ...
    {
        return $this->_getSubject()->getGeneratedCount();
    }
